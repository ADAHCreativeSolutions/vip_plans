  ...
  <div class="tableRow">
    <div class="normCell" style="width: 20%">
       <div class="tasks">
        ...
        <div class="tableRow">
          <ul>
            <li><a href="index.php?module=category&action=add">Add new</a></li>
            <li><a href="index.php?module=category&action=view">View All</a></li>
          </ul>
        </div>
      </div>
    </div>
...
<form action="index.php" method="POST" class="general">
  ...
  <input type="hidden" name="action" value="add" />
   <?php
    if($res['prod_cat_id'] > 0){ ?>
  <input type="hidden" name="category[prod_cat_id]" value="<?php echo $res['prod_cat_id']; ?>" />
  <?php
    }
  ?>
<div class="tableLike" style="width:100%">
  <div class="tableRow">
    ...
    <div class="normCell" style="width:70%">
      <input type="text" name="category[category]" id="username" placeholder="bottle category name" value="<?php echo $res['category']; ?>" required />
    </div>
  </div>
  ...
  <div class="tableRow">
    ...
    <div class="normCell" style="width:70%">
      ...
      <input type="checkbox" name="category[status]" checked="checked" value="ACTIVE" id="username" />
      <?php }else{ ?>
      <input type="checkbox" name="category[status]" value="ACTIVE" id="username" />
      <?php
      }
      ?>
    </div>
    ...
    <div class="tableLike" style="width:100%">
       ...
       <div class="tableRow"> 
        ...
        ?>
          ...
          <div class="normCell" style="width:80%"><?php echo $val['category']; ?></div>
          
          <div class="normCell" style="width:10%"><a href="index.php?module=category&action=add&id=<?php echo $val['prod_cat_id']; ?>">
