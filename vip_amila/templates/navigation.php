...
<div class="login">
  ...
  <div class="margin">
    ...
    <input type="email" name="member[member_email]" id="textfield" class="login-txt-box " placeholder="user name"/>
    </div>
  </div>
  <div class="forget-area "><a href="index.php?module=member&task=forgot-password" class="forget">forgot password?</a></div>
