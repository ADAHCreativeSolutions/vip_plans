  ...
  <div class="tableRow">
    <div class="normCell" style="width: 20%">
       <div class="tasks">
        ...
        <div class="tableRow">
          <ul>
            <li><a href="index.php?module=type&action=add">Add new</a></li>
            <li><a href="index.php?module=type&action=view">View All</a></li>
          </ul>
        </div>
      </div>
    </div>
...
<form action="index.php" method="POST" class="general">
  ...
  <?php
    if($res['type_id'] > 0){ ?>
  <input type="hidden" name="type[type_id]" value="<?php echo $res['type_id']; ?>" />
  <?php
    }
  ?>
<div class="tableLike" style="width:100%">
  <div class="tableRow">
    ...
    <div class="normCell" style="width:70%">
      <input type="text" name="type[type]" id="username" placeholder="type" value="<?php echo $res['type']; ?>" required />
    </div>
  </div>
  ...
  <div class="tableRow">
    ...
    <div class="normCell" style="width:70%">
      ...
      <input type="checkbox" name="type[status]" value="ACTIVE" checked="checked" id="username" />
      <?php }else{ ?>
      <input type="checkbox" name="type[status]" value="ACTIVE" id="username" />
      <?php
      }
      ?>
    </div>
    ...
    <div class="tableLike" style="width:100%">
       ...
       <div class="tableRow"> 
        ...
        ?>
          ...
          <div class="normCell" style="width:10%"><a href="index.php?module=type&action=add&id=<?php echo $val['type_id']; ?>">
