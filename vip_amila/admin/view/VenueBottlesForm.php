...
?>
 ...
 <form action="index.php" method="POST" class="general" enctype="multipart/form-data">
        ...
        <input type="hidden" name="action" value="bottles" />
  ...
  <div class="tableLike ajaxForms" style="width:100%;border: 7px solid #ECECEC;">
    ...
    <div class="tableRow head">
      <div class="normCell" style="width:80%">Add Bottles for Venue</div>
    ...
    <div class="tableRow">
      ...
      <div class="normCell" style="width:10%"><input type="checkbox" name="venue[bottles][][bottle_id]"  value="<?php echo $val['bottle_id']; ?>" checked="checked" /></div>
      <div class="normCell" style="width:80%"><?php echo $val['bottle_name']; ?></div>
    </div>
    <?php
      }
    }
